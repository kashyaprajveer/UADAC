...
class ActorNetwork(tf.keras.Model):
    def __init__(self, embedding_dim, hidden_dim):
        ...
        self.fc = tf.keras.Sequential([
            tf.keras.layers.Dense(hidden_dim, activation='relu', kernel_initializer=initializer),
            tf.keras.layers.Dense(hidden_dim, activation='relu', kernel_initializer=initializer),
            tf.keras.layers.Dense(embedding_dim, activation='tanh', kernel_initializer=initializer) # embedding_dim = 100
        ])
